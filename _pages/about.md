...
<section class="home-news" aria-labelledby="news-heading">
  ...
  <ul class="home-news__list">
    <li>[<time datetime="2026-09">Sep 2026</time>] Presented preliminary findings on <a href="{{ '/publications/' | relative_url }}">self-supervised ECG representation learning</a> at a research seminar.</li>
    <li>[<time datetime="2026-08">Aug 2026</time>] Prepared a manuscript on <strong>reliable arrhythmia classification</strong> for submission.</li>
    <li>[<time datetime="2026-07">Jul 2026</time>] Joined <a href="{{ '/experience/' | relative_url }}">Elite Research Lab</a> as a <strong>Student Researcher</strong>.</li>
    <li>[<time datetime="2026-06">Jun 2026</time>] Shared a research update on <strong>AI-based potato leaf disease detection</strong>.</li>
    <li>[<time datetime="2025-01">Jan 2025</time>] Began the <a href="{{ '/education/' | relative_url }}">M.Sc. in Computer Science and Engineering</a> at HSTU.</li>
  </ul>
</section>
